    ...
    try {
        ...
        if (existingDayPhongs > 0) {
            ...
            dayPhongs = await DayPhong.insertMany([
                { soDay: "A", tang: 0, viTri: "Tầng trệt - Dãy A", dienTich: 20 },
                { soDay: "B", tang: 0, viTri: "Tầng trệt - Dãy B", dienTich: 25 },
                { soDay: "A", tang: 1, viTri: "Tầng 1 - Dãy A", dienTich: 22 },
                { soDay: "B", tang: 1, viTri: "Tầng 1 - Dãy B", dienTich: 30 },
            ]);
